            ...
            child: Padding(
              ...
              child: FittedBox(
                child: SizedBox(
                  ...
                  child: Row(
                    children: <Widget>[
                      OfferWidget(color: Colors.blue[400],),
                      Padding(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage("assets/img_48.png"), fit: BoxFit.cover),
                            borderRadius: BorderRadius.circular(15),
                            boxShadow: [
                              BoxShadow(
                                color: Colors.grey.withOpacity(0.2),
                        ...
                        Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage("assets/img_44.png"), fit: BoxFit.cover),
                            borderRadius: BorderRadius.circular(15),
                            boxShadow: [
                              BoxShadow(
                                color: Colors.grey.withOpacity(0.2),
              ...
              SingleChildScrollView(
                  ...
                  child: Padding(
                      ...
                      child: Row(children: <Widget>[
                        ...
                        Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage("assets/img_47.png"), fit: BoxFit.cover),
                            color: Colors.blue[400],
                            borderRadius: BorderRadius.circular(20),
                            boxShadow: [
                              BoxShadow(
